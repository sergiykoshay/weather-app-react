...
const Weather: FC<WeatherProps> = ({ data }) => {
    ...
    const celsium = (data.main.temp - 273.15).toFixed(2);
            ...
            <div className="container">
                ...
                <div className="level" style={{alignItems: 'flex-start'}}>
                    <div className="level-item has-text-centered">
                        <div>
                            <p className="headihg">{data.weather[0].description}</p>
                    ...
                    <div className="level-item has-text-centered">
                        <div>
                            ...
                            <div className="title">
                                <p className="mb-1">{data.main.temp}K</p>
                                <p className="mb-1">{fahrenheit}<sup>&#8457;</sup></p>
                                <p>{celsium}<sup>&#8451;</sup></p>
                            </div>
                        </div>
                    </div>
